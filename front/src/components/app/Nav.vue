...
export default {
    ...
    data: () => ({
        links: [
            ...
            {title: 'Всі продажі', url: '/allselers', IsAdmin: true, IsLogist: true, IsAccountantCash: true, IsAccountantCashless: true},
            ...
            {title: 'Оплата готівкою', url: '/paymentcash', IsAdmin: true, IsAccountantCash: true},
            {title: 'Оплата безготівкою', url: '/paymentcashless', IsAdmin: true, IsAccountantCash: true, IsAccountantCashless: true},
            {title: 'Борги клієнтів', url: '/clientsdebt', IsAdmin: true},
